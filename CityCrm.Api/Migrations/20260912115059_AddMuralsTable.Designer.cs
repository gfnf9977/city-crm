...
namespace CityCrm.Api.Migrations
{
    ...
    [Migration("20260912115059_AddMuralsTable")]
    partial class AddMuralsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CityCrm.Api.Entities.CityIssue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CityIssues");
                });

            modelBuilder.Entity("CityCrm.Api.Entities.Mural", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CityCrm.Api.Entities.Premise", b =>
                {
                    ...
                    b.Property<string>("ProzorroLink")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("CityCrm.Api.Entities.TenderRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CityCrm.Api.Entities.TenderRequest", b =>
                {
                    b.HasOne("CityCrm.Api.Entities.Premise", "Premise")
                        .WithMany()
